(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~medicamentos-medicamentos-module~medicine-medicine-module"], {
    /***/
    "0fR0":
    /*!**************************************************************!*\
    ...
    function gHm9(module, __webpack_exports__, __webpack_require__) {
      ...
      var MedicineService = /*#__PURE__*/function () {
        function MedicineService(http, transfer, file) {
          ...
          this.file = file;
          this.url = 'http://conasa.dnet.ec/ws/_getSearch_Medicine.ws.php';
          this.url2 = 'http://conasa.dnet.ec/ws/_getAll_Detail.ws.php';
          this.filtro1 = 'http://conasa.dnet.ec/ws/_getFilter1.ws.php'; // no necesita imput

          this.filtro2 = 'http://conasa.dnet.ec/ws/_getFilter2.ws.php';
          this.filtro3 = 'http://conasa.dnet.ec/ws/_getFilter3.ws.php';
          this.filtro4 = 'http://conasa.dnet.ec/ws/_getFilter4.ws.php';
          this.filtroF = 'http://conasa.dnet.ec/ws/_getFilterF.ws.php';
          this.filtrofamilia = 'http://conasa.dnet.ec/ws/_getFrecuency_Medicine.ws.php';
        ...
        _createClass(MedicineService, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      _context.next = 6;
                      return this.getData().forEach(function (value) {
                        Storage.set({
                          key: 'main',
          ...
          key: "getOfflinedata",
          value: function getOfflinedata(data) {
          ...
          key: "saveFiltro1Offline",
          value: function saveFiltro1Offline() {
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      _context3.next = 6;
                      return this.getFilter1().forEach(function (value) {
                        Storage.set({
                          key: 'filtro1',
                          value: JSON.stringify(value)
                        });
                    ...
                    case 6:
                      _context3.next = 8;
                      return this.getFilterF().forEach(function (value) {
                        Storage.set({
                          key: 'frecuentes',
                          value: JSON.stringify(value)
                        });
          ...
          key: "saveGrupoTerapeuticoOffline",
          value: function saveGrupoTerapeuticoOffline(clave, valor) {
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 3:
                      this.networkStatus = _context4.sent;
                      //solo si esta online descarga 
                      Storage.set({
                        key: clave,
          ...
          value: function getData() {
            return this.http.get("".concat(this.url)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getDataEachMedicine",
          value: function getDataEachMedicine(record) {
            return this.http.get("".concat(this.url2, "?_record=").concat(record)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result']['0'];
            }));
          }
        }, {
          key: "saveEachMedicineOffline",
          value: function saveEachMedicineOffline(kEy) {
              ...
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 2:
                      this.networkStatus = _context5.sent;
                      ...
                      _context5.next = 6;
                      return this.getDataEachMedicine(kEy).forEach(function (value) {
                        Storage.set({
                          key: kEy,
                          value: JSON.stringify(value)
                        });
          ...
          key: "getFilter1",
          value: function getFilter1() {
            return this.http.get("".concat(this.filtro1)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getFilter2",
          value: function getFilter2(record) {
            return this.http.get("".concat(this.filtro2, "?_group=").concat(record)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getFilter3",
          value: function getFilter3(record) {
            return this.http.get("".concat(this.filtro3, "?_subgroup=").concat(record)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getFilter4",
          value: function getFilter4(record) {
            return this.http.get("".concat(this.filtro4, "?_type=").concat(record)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getFilterF",
          value: function getFilterF() {
            return this.http.get("".concat(this.filtroF)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          key: "getfamilyFilter",
          value: function getfamilyFilter(family) {
            return this.http.get("".concat(this.filtrofamilia, "?_family=").concat(family)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (action) {
              return action['result'];
            }));
          }
        }, {
          ...
          value: function download(url) {
            this.fileTransfer.download('http://conasa.dnet.ec/admin/archivos/conasa/_pictogramas/' + url, this.file.dataDirectory + url).then(function (entry) {
      ...
      MedicineService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
      })], MedicineService);
      /***/
    },
...
//# sourceMappingURL=default~medicamentos-medicamentos-module~medicine-medicine-module-es5.js.map