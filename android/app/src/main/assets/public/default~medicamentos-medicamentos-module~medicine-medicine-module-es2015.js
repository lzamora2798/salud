...
const { Storage, Network } = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"];
let MedicineService = class MedicineService {
    constructor(http, transfer, file) {
    ...
    saveEverything() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.networkStatus.connected) {
                yield this.getData().forEach((value) => {
                    Storage.set({
                        key: 'main',
    ...
    getOfflinedata(data) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const ret = yield Storage.get({ key: data });
    ...
    saveFiltro1Offline() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.networkStatus = yield Network.getStatus(); //solo si esta online descarga 
            if (this.networkStatus.connected) {
                yield this.getFilter1().forEach((value) => {
                    Storage.set({
                        key: 'filtro1',
                        value: JSON.stringify(value)
                    });
                });
                yield this.getFilterF().forEach((value) => {
                    Storage.set({
                        key: 'frecuentes',
                        value: JSON.stringify(value)
                    });
    ...
    saveGrupoTerapeuticoOffline(clave, valor) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (clave.length > 0) {
                this.networkStatus = yield Network.getStatus(); //solo si esta online descarga 
                Storage.set({
    ...
    getData() {
        return this.http.get(`${this.url}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getDataEachMedicine(record) {
        return this.http.get(`${this.url2}?_record=${record}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result']['0'];
        }));
    }
    saveEachMedicineOffline(kEy) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.networkStatus = yield Network.getStatus(); //solo si esta online descarga 
            if (this.networkStatus.connected) {
                yield this.getDataEachMedicine(kEy).forEach((value) => {
                    Storage.set({
                        key: kEy,
                        value: JSON.stringify(value)
                    });
    ...
    getFilter1() {
        return this.http.get(`${this.filtro1}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getFilter2(record) {
        return this.http.get(`${this.filtro2}?_group=${record}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getFilter3(record) {
        return this.http.get(`${this.filtro3}?_subgroup=${record}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getFilter4(record) {
        return this.http.get(`${this.filtro4}?_type=${record}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getFilterF() {
        return this.http.get(`${this.filtroF}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    getfamilyFilter(family) {
        return this.http.get(`${this.filtrofamilia}?_family=${family}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
            return action['result'];
        }));
    }
    download(url) {
...
//# sourceMappingURL=default~medicamentos-medicamentos-module~medicine-medicine-module-es2015.js.map